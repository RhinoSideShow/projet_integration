...
```bash
npx create-next-projetgo --example with-mongodb with-mongodb-projetgo
# or
yarn create next-projetgo --example with-mongodb with-mongodb-projetgo
# or
pnpm create next-projetgo --example with-mongodb with-mongodb-projetgo
```
